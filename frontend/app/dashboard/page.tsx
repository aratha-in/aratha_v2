      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-9 glass-panel p-6 sm:p-8 border-white/10 min-h-[480px] z-10 relative">
          ...
          {activeTab === "invoices" && (
            <div className="flex flex-col gap-8">
              <div>
                <h2 className="text-xl font-bold text-white tracking-tight">Invoices & Financial Agreements</h2>
                <p className="text-slate-400 text-xs mt-0.5 leading-relaxed">
                  Review invoice receipts, check pending milestone balances, and make direct online payments.
                </p>
              </div>
